...
@NamedQueries({
    ...
    @NamedQuery(name = "Movie.searchName", query = "SELECT m from Movie m where m.Title like :ptype"),
    ...
    @NamedQuery(name = "Movie.sortByVotes", query = "SELECT m from Movie m order by m.imdbVotes DESC"),
