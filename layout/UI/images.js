//funtion to show snackbar on click of the search bar
function myFunction() {
                  ...
                  htmlText += '<p id="box-p"> Rated: ' + value[0].Rated + '</p>';
                   htmlText += '<p id="box-p"> Released: ' + value[0].Released + '</p>';
                    htmlText += '<p id="box-p"> Runtime: ' + value[0].Runtime + '</p>';
                     ...
                     document.getElementById("mySidenav").style.backgroundImage = "linear-gradient(to left, #804d00 0%,orange 100%), url('" + value[0].Poster + "')";
                     // linear-gradient will be genrated to blend mode the background image
